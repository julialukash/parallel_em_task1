function [label,x1,x2] = importfile_2dim(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [LABEL,X1,X2] = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   [LABEL,X1,X2] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [label,x1,x2] = importfile_2dim('result_test_set_1.csv',1, 10000);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/09/25 16:11:09
